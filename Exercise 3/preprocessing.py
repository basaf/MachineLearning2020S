...
communities_x, communities_y = preprocess_communities()
print(communities_x, communities_y)

traffic_x, traffic_y = preprocess_traffic()
print(traffic_x, traffic_y)

estate_x, estate_y = preprocess_real_estate()
print(estate_x, estate_y)

student_x, student_y = preprocess_student()
